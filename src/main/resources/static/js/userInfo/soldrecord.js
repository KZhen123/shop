layui.use(['form', 'element', 'util', 'carousel', 'laypage', 'layer','table'], function () {
    ...
    table.render({
        elem: '#sold'
        , url: basePath+'/order/selectSellerOrder'
        , page: {
            ...
            , {field: 'commodityName', title: '商品名称', width: 180, align:'center'}
            , {field: 'commodityDesc', title: '商品描述', width: 280, align:'center'}
            , {field: 'price', title: '售价', width: 90, align:'center'}
            , {field: 'receiveName', title: '收货昵称', width: 180, align:'center'}
            , {field: 'receivePhone', title: '收货号码', width: 180, align:'center'}
            , {field: 'address', title: '收货地址', width: 280, align:'center'}
